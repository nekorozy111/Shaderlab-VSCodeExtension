...
export class HlslParser {
    ...
    private parseFunctionOrVariable():
        ...
        if (
            ...
            return this.parseFunctionAfterName(
                typeToken,
                nameToken
            );
        }
    ...
    private parseFunctionAfterName(
        typeToken: Token,
        nameToken: Token
    ): HlslFunctionNode {
